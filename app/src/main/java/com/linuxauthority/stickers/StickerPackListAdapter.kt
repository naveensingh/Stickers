...
private class StickerPackListAdapter internal constructor(private var stickerPacks: List<StickerPack>, private val onAddButtonClickedListener: OnAddButtonClickedListener) : RecyclerView.Adapter<StickerPackListItemViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: StickerPackListItemViewHolder, index: Int) {
        ...
        for (i in 0 until actualNumberOfStickersToShow) {
            ...
            rowImage.setImageURI(getStickerAssetUri(pack.identifier, pack.stickers[i].imageFileName))
